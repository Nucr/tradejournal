...
export default function JournalPage() {
  ...
  try {
    console.log("BEFORE RENDER: filtered type", typeof filtered, "isArray", Array.isArray(filtered), "length", filtered?.length);
    ...
    console.error("JournalPage RENDER ERROR:", renderErr);
    return <div className="p-8 text-coral-400">Render hatası: {String(renderErr)}</div>;
  }
}
