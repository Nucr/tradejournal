...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(mapError(err instanceof Error && "code" in err ? (err as { code?: string }).code : undefined));
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <main className="min-h-screen flex bg-ink-950">
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          {sent ? (
            <div className="rounded-lg border border-mint-500/30 bg-mint-500/10 p-4 text-sm text-mint-300">
...
function mapError(code?: string) {
  switch (code) {
    ...
    default:
      return "Bir hata oluştu, bilgilerini kontrol et.";
  }
}
