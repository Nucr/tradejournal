...
const FEATURES = [
  {
    ...
    title: "İşlem Günlüğü",
    desc: "Ekran görüntüsü, giriş/çıkış, RR ve stratejiyle her işlemini eksiksiz kaydet.",
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Günlük, haftalık, aylık ve yıllık performansını interaktif grafiklerle takip et.",
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Diğer traderlarla kıyaslanabilir puanınla rekabet et ve kendini geliştir.",
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Strateji Takibi",
    desc: "Hangi stratejinin kârlı olduğunu gör, veriye dayalı kararlar al ve optimize et.",
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Başarımlar & Rütbeler",
    desc: "Oyunlaştırılmış rozet sistemiyle motivasyonunu yüksek tut, ilerlemeni gör.",
  },
  {
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Diğer traderlarla iletişime geç, stratejilerini tartış ve deneyim paylaş.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mt-3 text-paper-300 max-w-xl mx-auto">
            Ledger ile işlemlerini kaydetmekten performans analizine, toplulukla
            iletişimden oyunlaştırılmış başarılara kadar her şey tek bir yerde.
          </p>
        </div>
