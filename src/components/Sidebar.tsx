    ...
    <>
      ...
      >
        ...
        <div className={`flex flex-col px-3 py-4 border-t border-ink-800 gap-2 ${open ? "" : "items-center px-0"}`}>
          <button
            onClick={toggle}
            className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-paper-300 hover:bg-ink-800 hover:text-paper-100 transition ${open ? "w-full" : "justify-center px-0"}`}
            title={open ? undefined : (theme === "dark" ? "Açık Mod" : "Koyu Mod")}
          >
            {theme === "dark" ? (
            ...
            {open && (theme === "dark" ? "Açık Mod" : "Koyu Mod")}
          </button>
