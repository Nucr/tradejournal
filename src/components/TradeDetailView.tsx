    ...
    <div className="rounded-xl border border-ink-800 bg-ink-900 overflow-hidden">
      ...
      <div className="p-4 border-b border-ink-800 space-y-3">
        <div className="flex items-center gap-2">
          ...
          >
            <svg className={`w-4 h-4 ${liked ? "" : "opacity-40"}`} fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <svg className={`w-4 h-4 ${disliked ? "" : "opacity-40"}`} fill="currentColor" viewBox="0 0 24 24">
